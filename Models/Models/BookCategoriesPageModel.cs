...
namespace Toma_Alexandru_Lab2.Models
{
    public class BookCategoriesPageModel :PageModel
    {   
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Toma_Alexandru_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Toma_Alexandru_Lab2Context context,
